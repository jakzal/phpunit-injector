...
final class ReflectionExtractor implements Extractor
{
    ...
    private function createServiceProperty(\ReflectionProperty $propertyReflection, DocBlockFactory $docBlockFactory, Context $context): ?TestService
    {
        ...
        return new TestService($propertyReflection->getDeclaringClass()->getName(), $propertyReflection->getName(), $serviceId);
    }
